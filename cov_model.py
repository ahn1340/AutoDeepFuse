...
class COVsearchModel:
    ...
    def train(self, train_loader, val_loader, test_loader):
        ...
        for epoch in range(self.start_epoch, self.args.training.num_epochs_train):
            ...
            if self.model.module.discretization == 'all':
                name = 'performance_dict_all.json'
            elif self.model.module.discretization == 'topk':
                name = 'performance_dict_topk.json'
            else:
                raise ValueError("self.discretization is neither all nor topk!")

            json.dump(performance_dict, open(os.path.join(self.args.log_dir, name), 'w'))
            print("Saved.")
